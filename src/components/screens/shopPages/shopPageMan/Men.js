  ...
  return (
    <View style={styles.category_cart} >
      <View style={{ flex: 1, justifyContent: 'center' }}>
        <Text style={{ fontSize: 18, fontWeight: '400', lineHeight: 22, color: Colors.black, left: 23, }}>{title}</Text>
      </View>
      <View style={{ flex: 1, position: 'relative', }}>
        <Image style={{ width: '100%', height: 100, position: 'absolute', borderBottomRightRadius: 8, borderTopRightRadius: 8 }} source={{ uri: image }}
  ...
  return (
    ...
    <ScrollView style={styles.container}>
      <View style={styles.box_1}>
        <Text style={styles.txt1_box}>
          SUMMER SALES
        </Text>
        <Text style={styles.txt2_box}>
          Up to 50% off
        </Text>
      </View>
      <FlatList
...
const DataWomen = [
  ...
  },
  {
      "_id": "6",
      "title": "Sexy",
      "image": "https://lp2.hm.com/hmgoepprod?set=format%5Bwebp%5D%2Cquality%5B79%5D%2Csource%5B%2F66%2F48%2F6648d107d2a03baf60e8766254c58d82cfebefb0.jpg%5D%2Corigin%5Bdam%5D%2Ccategory%5B%5D%2Ctype%5BLOOKBOOK%5D%2Cres%5Bm%5D%2Chmver%5B1%5D&call=url%5Bfile%3A%2Fproduct%2Fmain%5D",
  },
  {
      "_id": "7",
      "title": "Sexy",
      "image": "https://lp2.hm.com/hmgoepprod?set=source[/4d/ef/4defd708ed32d0f6cf73cd8a765c3937b8ac826b.jpg],origin[dam],category[],type[DESCRIPTIVESTILLLIFE],res[y],hmver[2]&call=url[file:/product/main]",
  },
]