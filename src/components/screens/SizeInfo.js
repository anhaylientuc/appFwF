    ...
    return (
      ...
      >
        ...
        <View style={{ flexDirection: 'row', marginBottom: 20 }}>
          ...
          <View>
            <Text style={{ fontSize: 16, color: Colors.black, fontWeight: '700' }}>Ngực</Text>
            <Text style={styles.txt_measure_title}>Đo vòng ngực đầy đặn nhất khu vực xung quanh của ngực</Text>
          </View>
        </View>
        <View style={{ flexDirection: 'row', marginBottom: 20 }}>
          <View style={styles.container_ic_measure}>
          ...
          <View>
            <Text style={{ fontSize: 16, color: Colors.black, fontWeight: '700' }}>Eo</Text>
            <Text style={{ fontSize: 12, color: Colors.black, marginTop: 8 }}>Đo vòng eo tại vị trí hẹp nhất</Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 20 }}>
          ...
          <View>
            <Text style={{ fontSize: 16, color: Colors.black, fontWeight: '700' }}>Chiều dài cánh tay</Text>
            <Text style={{ fontSize: 12, color: Colors.black, marginTop: 8 }}>Đo từ vai đến cổ tay</Text>
          </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 20 }}>
          ...
          <View>
            <Text style={{ fontSize: 16, color: Colors.black, fontWeight: '700' }}>Đường viền cổ áo</Text>
    ...
    <KeyboardAvoidingView>
      <ScrollView showsVerticalScrollIndicator={false} style={styles.wrapper}>
        <View style={{ marginTop: 32, paddingHorizontal: 9 }}>
          ...
          >
            <View />
            <Text style={{ fontSize: 24, fontWeight: '600' }}>Áo và áo khoác</Text>
        ...
        <View style={styles.container_measure}>
          <Text style={isShowMeasureSize ? styles.txt_measure_active : styles.txt_measure}>Cách đo lường</Text>
          <TouchableOpacity onPress={() => setIsShowMeasureSize(!isShowMeasureSize)}>
            <Icons.Entypo name={!isShowMeasureSize ? 'chevron-small-down' : 'chevron-small-up'} size={20} />
          </TouchableOpacity>
        </View>
        ...
        <View style={{ backgroundColor: Colors.white, paddingBottom: 50 }}>
          ...
          {
            /**
             * Logic: Khi ấn vào Button thông thường => show TabSize1() và ngược lại với button Dáng dài
             */

            !isShowSize ? TabSize1() : TabSize2()
          }
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
