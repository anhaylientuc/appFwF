...
const ReturnMethod = props => {
  ...
  return (
    <View style={{ backgroundColor: Colors.grayBg }}>
      ...
      <View style={{ padding: 28, backgroundColor: Colors.white }}>
        ...
        <Text style={{ textAlign: 'left', fontSize: 14, marginBottom: 8 }}>
          Chọn giữa giao hàng tận nhà, địa chỉ thay thế hoặc địa điểm giao nhận.
        </Text>
        <Text style={{ marginVertical: 8, fontSize: 20, fontWeight: '600' }}>
          Đổi trả
        </Text>
        <Text>
