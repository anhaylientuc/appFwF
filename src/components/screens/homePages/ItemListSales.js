        ...
        <View style={{ marginTop: 22 }}>
          ...
          <View style={{ flex: 1, }}>
            ...
            <View style={{
              ...
              <Text style={{ color: '#fff', fontWeight: '500' }}>-20%</Text>
            </View>
          </View>
          ...
          <Text style={{ color: '#9B9B9B', marginTop: 6 }}>Dorothy Perkins</Text>
          <Text style={{ color: '#222', fontSize: 16, fontWeight: '400' }}>Evening Dress</Text>
          <View style={{ flexDirection: 'row' }}>
            <Text
              style={{ fontSize: 14, fontWeight: '500', color: '#9B9B9B', marginRight: 4 }}>{data.cost}$
            </Text>
            <Text style={{ fontSize: 14, fontWeight: '500', color: '#DB3022' }}>{data.reduced_price}$</Text>
          </View>
